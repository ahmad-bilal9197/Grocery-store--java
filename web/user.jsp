...
<div>
    <div class="item1" style="background-color:hsl(310, 91%, 50%); ">User Registration</div>
  </div>
  <br><br>
<tr>
  ...
  <tr>
    <td align="center" valign="top"><table width="1000" height="306" border="0" bgcolor="#FFFFFF">
      <tr class="table">
        <td width="240" height="302" valign="top"><p class="font-verdana"><img src="shopping5.jpg" width="335" height="302"></p></td>
        ...
        <td width="736" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0">
          ...
          <tr>
            <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center" valign="top"><form name="form1" method="post" action="user-db.jsp">
                    ...
                    <tr>
                      ...
                      <td align="center" valign="top"><table width="57%" height="221" border="0">
                        ...
                        <tr>
                          <td>Password</td>
                          <td>&nbsp;</td>
                          <td><input type="password" name="f6" id="f6"></td>
                        </tr>
                        <tr>
                          <td>Sex</td>
                          <td>&nbsp;</td>
