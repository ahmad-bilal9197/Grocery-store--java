...
<tr>
  ...
  <tr>
    <td align="center" valign="top"><table width="1000" height="306" border="0" bgcolor="#FFFFFF">
      <tr class="table">
        <td width="240" height="302" valign="top"><p class="font-verdana"><img src="logo.jpg" width="335" height="302"></p></td>
        <td width="10" valign="top" bgcolor="#FFFFFF">&nbsp;</td>
        <td width="736" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0">
          <tr>
            <td height="23" align="left" valign="top" class="font-verdana"><h3><strong><em>PAY &amp; DELIVERY </em></strong></h3></td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center" valign="top"><form name="form1" method="post" action="pay-db.jsp">
